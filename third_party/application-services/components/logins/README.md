...
### Wild Buzzard import status

This source is quarantined for extraction of provider-neutral local password storage. Wild
Buzzard does not import the upstream Android telemetry integration, and no part of this snapshot
is in the production workspace. Mozilla Sync and NSS dependencies must be separated behind
explicit interfaces before adoption.
