...
/// to clean up / shrink the database. They're split into independently callable steps so an
/// embedding application can schedule them without blocking other browser work.
///
