...
This source is quarantined for extraction of provider-neutral local Places storage. Wild Buzzard
does not import the upstream Android telemetry integration, and no part of this snapshot is in the
production workspace. Mozilla Sync dependencies must be removed or feature-gated before adoption.
